...
\textbf{Highlights}:
\begin{itemize}
\item Built and led three distributed engineering teams
\begin{itemize}
\item Data Science and Machine Learning - 5 engineers
\item Frontend and Backend - 6 engineers
\item Devops - 3 engineers
\end{itemize}
...
\begin{itemize}
\item Designed and led the implementation of a high-performance, full-system,
functional, multicore simulator for the ARM architecture capable of booting
unmodified Linux and Android software stacks. The simulator was written in C++. I
implemented most of the initial functionality: memory model, interrupt routing, DMA
...
Designed, implemented and evaluated a storage IO bandwidth manager for the ESX
server.
}
